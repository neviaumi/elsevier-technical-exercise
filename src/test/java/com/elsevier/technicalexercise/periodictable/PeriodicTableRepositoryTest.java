...
class PeriodicTableRepositoryTest {
    ...
    @BeforeEach
    void setUp() {
        periodicTableRepository = new PeriodicTableRepository(objectStorage);
    }
    ...
    void testFindElementsByGroup() throws ExecutionException, InterruptedException {
        ...
        // When
        CompletableFuture<List<ElementEntity>> futureElements = periodicTableRepository.findElements("1");
    ...
    void testFindElementsByBlockType() throws ExecutionException, InterruptedException {
        ...
        // When
        CompletableFuture<List<ElementEntity>> futureElements = periodicTableRepository.findElements("s-block");
